...
su otrs -s /bin/bash -c '/opt/otrs/bin/otrs.Console.pl Admin::Service::Add --name TIC --comment "T.I."'
su otrs -s /bin/bash -c '/opt/otrs/bin/otrs.Console.pl Admin::Service::Add --name Redes --parent-name TIC --comment "Redes"'
su otrs -s /bin/bash -c '/opt/otrs/bin/otrs.Console.pl Admin::Service::Add --name Desenvolvimento --parent-name TIC --comment "Desenvolvimento"'
